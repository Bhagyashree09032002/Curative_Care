...
public class Search extends AppCompatActivity {
    ...
    String url=IPaddress.ip+"search.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferenceManager=new SharedPreferenceManager(Search.this);
        ...
        asyncHttpClient.get(url, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if(object.getString("success").equals("200")){
                        ...
                        ArrayAdapter arrayAdapter=new ArrayAdapter(Search.this,android.R.layout.simple_expandable_list_item_1,arrayList){
                            @Override
                        ...
                        Toast.makeText(Search.this,object.getString("message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(Search.this,"JSON ERROR", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                progressDialog.dismiss();
                Toast.makeText(Search.this,"Connection ERROR", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
